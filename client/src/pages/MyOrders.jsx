...
const MyOrders = () => {
        ...
        return (
            <div className='px-4 md:px-16 lg:px-24 xl:px-32'>
                <div className='max-w-2xl mx-auto mt-14 bg-white rounded-xl border border-gray-200 p-8 text-center'>
                    ...
                    <p className='text-sm text-gray-500 mt-2'>You haven't purchase and listing yet</p>
                </div>
            </div>
        )
    }
    ...
    return (
        <div className='px-4 md:px-16 lg:px-24 xl:px-32 mt-6'>
            ...
            <div className='space-y-4'>
                {orders.map((order) => {
                    ...
                    return (
                        <div key={id} className='bg-white rounded-lg border p-5 border-gray-200 flex flex-col max-w-4xl'>
                                    ...
                                    <div className='flex items-start justify-between gap-4'>
                                        <div>
                                            ...
                                            <div className='flex gap-2 mt-2'>
                                                {listing.verified && (
                                                    <span className='flex items-center text-indigo-600 text-xs bg-indigo-50 px-2 py-1 rounded-md'>
                                                ...
                                                {listing.monetized && (
                                                    <span className='flex items-center text-green-600 text-xs bg-green-50 px-2 py-1 rounded-md'>
                                                        <DollarSign className='w-4 h-4 mr-1' /> Monetized
                                                    </span>
                                                )}
                                            </div>
                                        </div>
                            ...
                            <div className='flex flex-col gap-2 items-end'>
                                <button
                                    className='flex items-center bg-white gap-2 border border-gray-200 px-3 py-2 rounded hover:shadow text-sm'
                            ...
                            {isExpanded && (
                                <div className='mt-4 pt-4 md:mt-0'>
